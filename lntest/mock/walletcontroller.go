...
func (w *WalletController) FetchInputInfo(
	...
	utxo := &lnwallet.Utxo{
		...
		Value:         10 * bronutil.SatoshiPerBitcoin,
		PkScript:      []byte("dummy"),
		Confirmations: 1,
		OutPoint:      *prevOut,
	}
...
func (w *WalletController) AddressInfo(
	bronutil.Address) (waddrmgr.ManagedAddress, error) {
...
func (w *WalletController) ListUnspentWitness(int32, int32,
	...
	utxo := &lnwallet.Utxo{
		AddressType: lnwallet.WitnessPubKey,
		Value:       bronutil.Amount(10 * bronutil.SatoshiPerBitcoin),
...
func (w *WalletController) LeaseOutput(wtxmgr.LockID, wire.OutPoint,
	time.Duration) (time.Time, []byte, bronutil.Amount, error) {
