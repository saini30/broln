...
// TestbrolightningnetworkDaemon performs a series of integration tests amongst a
// programmatically driven network of broln nodes.
func TestbrolightningnetworkDaemon(t *testing.T) {
	...
	for idx, testCase := range testCases {
		...
		success := t.Run(name, func(t1 *testing.T) {
			...
			brolnHarness.Alice.AddToLogf(logLine)
			brolnHarness.Bob.AddToLogf(logLine)
