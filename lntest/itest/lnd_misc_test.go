...
func testSphinxReplayPersistence(net *lntest.NetworkHarness, t *harnessTest) {
	...
	net.SendCoins(t.t, bronutil.SatoshiPerBitcoin, carol)
	...
	net.SendCoins(t.t, bronutil.SatoshiPerBitcoin, fred)
...
func testSweepAllCoins(net *lntest.NetworkHarness, t *harnessTest) {
	...
	net.SendCoins(t.t, bronutil.SatoshiPerBitcoin, ainz)

	net.SendCoinsNP2WKH(t.t, bronutil.SatoshiPerBitcoin, ainz)
