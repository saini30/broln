...
import (
	...
	"github.com/brolightningnetwork/broln/lnrpc/watchtowerrpc"
	"github.com/brolightningnetwork/broln/lnrpc/wtclientrpc"
...
func (cfg *BaseNodeConfig) GenArgs() []string {
	...
	nodeArgs := []string{
		...
		fmt.Sprintf("--brolndir=%v", cfg.BaseDir),
...
func (hn *HarnessNode) initLightningClient() error {
	...
	hn.wg.Add(1)
	go hn.brolightningnetworkWatcher()
...
// closeChanWatchRequest is a request to the brolightningnetworkWatcher to be
...
// brolightningnetworkWatcher is a goroutine which is able to dispatch
...
func (hn *HarnessNode) brolightningnetworkWatcher() {
	defer hn.wg.Done()
