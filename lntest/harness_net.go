...
func (n *NetworkHarness) SetUp(t *testing.T,
	...
	expectedBalance := int64(bronutil.SatoshiPerBitcoin * 10)
...
func (n *NetworkHarness) SendCoinsP2TR(t *testing.T, amt bronutil.Amount,
	target *HarnessNode) {
...
func (n *NetworkHarness) SendCoinsOfType(amt bronutil.Amount, target *HarnessNode,
