			...
			coins: []Coin{
				{
					TxOut: wire.TxOut{
						PkScript: p2wkhScript,
						Value:    1 * bronutil.SatoshiPerBitcoin,
					},
				},
			},
			outputValue: 0.5 * bronutil.SatoshiPerBitcoin,

			// The one and only input will be selected.
			expectedInput: []bronutil.Amount{
				1 * bronutil.SatoshiPerBitcoin,
			},
			// Change will be what's left minus the fee.
			expectedChange: 0.5*bronutil.SatoshiPerBitcoin - fundingFee(feeRate, 1, true),
		},
		{
			...
			outputValue: 1 * bronutil.SatoshiPerBitcoin,
			expectErr:   true,
		},
		{
			...
			outputValue: 1*bronutil.SatoshiPerBitcoin - fundingFee(feeRate, 1, false) - dustLimit,
	...
	testCases := []testCase{
		{
			...
			spendValue: 1 * bronutil.SatoshiPerBitcoin,

			// The one and only input will be selected.
			expectedInput: []bronutil.Amount{
				1 * bronutil.SatoshiPerBitcoin,
			},
			expectedFundingAmt: 1*bronutil.SatoshiPerBitcoin - fundingFee(feeRate, 1, false),
			expectedChange:     0,
		},
		{
			...
			spendValue: 0.5 * bronutil.SatoshiPerBitcoin,

			// The one and only input will be selected.
			expectedInput: []bronutil.Amount{
				1 * bronutil.SatoshiPerBitcoin,
			},
			expectedFundingAmt: 0.5*bronutil.SatoshiPerBitcoin - fundingFee(feeRate, 1, true),
			expectedChange:     0.5 * bronutil.SatoshiPerBitcoin,
		},
		{
		...
		},
		{
			...
			spendValue: 1*bronutil.SatoshiPerBitcoin - dust,
