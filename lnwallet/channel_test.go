...
import (
	...
	"github.com/brsuite/brond/btcec/v2"
	"github.com/brsuite/brond/bronutil"
	...
	"github.com/brolightningnetwork/broln/lnwallet/chainfee"
...
func testAddSettleWorkflow(t *testing.T, tweakless bool) {
	...
	htlcAmt := lnwire.NewMSatFromSatoshis(bronutil.SatoshiPerBitcoin)
	...
	mSatTransferred := lnwire.NewMSatFromSatoshis(bronutil.SatoshiPerBitcoin)
...
func TestCancelHTLC(t *testing.T) {
	...
	// of the new HTLC.
	aliceExpectedBalance := bronutil.Amount(bronutil.SatoshiPerBitcoin*4) -
	...
	expectedBalance := bronutil.Amount(bronutil.SatoshiPerBitcoin * 5)
...
func TestCooperativeCloseDustAdherence(t *testing.T) {
	...
	aliceBal := lnwire.NewMSatFromSatoshis(bronutil.SatoshiPerBitcoin)
...
func TestUpdateFeeConcurrentSig(t *testing.T) {
	...
	htlc := &lnwire.UpdateAddHTLC{
		PaymentHash: paymentHash,
		Amount:      bronutil.SatoshiPerBitcoin,
		Expiry:      uint32(5),
	}
...
func TestAddHTLCNegativeBalance(t *testing.T) {
	...
	htlcAmt = lnwire.NewMSatFromSatoshis(2 * bronutil.SatoshiPerBitcoin)
...
func TestFeeUpdateOldDiskFormat(t *testing.T) {
	...
	htlcAmt := lnwire.NewMSatFromSatoshis(0.1 * bronutil.SatoshiPerBitcoin)
	const numHTLCs = 30
...
func TestChanAvailableBalanceNearHtlcFee(t *testing.T) {
	...
	aliceBalance := lnwire.NewMSatFromSatoshis(5 * bronutil.SatoshiPerBitcoin)
	bobBalance := lnwire.NewMSatFromSatoshis(5 * bronutil.SatoshiPerBitcoin)
...
func TestDesyncHTLCs(t *testing.T) {
	...
	htlcAmt := lnwire.NewMSatFromSatoshis(4.1 * bronutil.SatoshiPerBitcoin)
	htlc, _ := createHTLC(0, htlcAmt)
	...
	htlcAmt = lnwire.NewMSatFromSatoshis(1 * bronutil.SatoshiPerBitcoin)
...
func TestMaxPendingAmount(t *testing.T) {
	...
	maxPending := lnwire.NewMSatFromSatoshis(bronutil.SatoshiPerBitcoin * 3)
	...
	const numHTLCs = 2
	htlcAmt := lnwire.NewMSatFromSatoshis(1.5 * bronutil.SatoshiPerBitcoin)
	for i := 0; i < numHTLCs; i++ {
		htlc, _ := createHTLC(i, htlcAmt)
		if _, err := aliceChannel.AddHTLC(htlc, nil); err != nil {
			t.Fatalf("unable to add htlc: %v", err)
...
func TestChanReserve(t *testing.T) {
	...
	setupChannels := func() (*LightningChannel, *LightningChannel, func()) {
		...
		bobMinReserve := bronutil.Amount(6 * bronutil.SatoshiPerBitcoin)
	...
	//	Alice:	4.5
	//	Bob:	5.0
	htlcAmt := lnwire.NewMSatFromSatoshis(0.5 * bronutil.SatoshiPerBitcoin)
	...
	assertChannelBalances(
		...
		bronutil.SatoshiPerBitcoin*4.5-commitFee, bronutil.SatoshiPerBitcoin*5,
	)
	...
	//	Alice:	1.5
	//	Bob:	9.5
	htlcAmt = lnwire.NewMSatFromSatoshis(3.5 * bronutil.SatoshiPerBitcoin)
	...
	assertChannelBalances(
		t, aliceChannel, bobChannel,
		bronutil.SatoshiPerBitcoin*3-commitFee, bronutil.SatoshiPerBitcoin*5,
	)
	...
	assertChannelBalances(
		t, aliceChannel, bobChannel,
		bronutil.SatoshiPerBitcoin*3-commitFee, bronutil.SatoshiPerBitcoin*7,
	)
	...
	assertChannelBalances(
		t, aliceChannel, bobChannel,
		bronutil.SatoshiPerBitcoin*3-commitFee, bronutil.SatoshiPerBitcoin*6,
	)
}
...
func TestChanReserveRemoteInitiator(t *testing.T) {
	...
	commitFee := aliceChannel.channelState.LocalCommitment.CommitFee
	aliceMinReserve := 5*bronutil.SatoshiPerBitcoin - commitFee
...
func TestChanReserveLocalInitiatorDustHtlc(t *testing.T) {
	...
	commitFee := aliceChannel.channelState.LocalCommitment.CommitFee
	aliceMinReserve := 5*bronutil.SatoshiPerBitcoin - commitFee - htlcSat
...
func TestMinHTLC(t *testing.T) {
	...
	minValue := lnwire.NewMSatFromSatoshis(0.1 * bronutil.SatoshiPerBitcoin)
