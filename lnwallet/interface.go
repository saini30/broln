...
import (
	...
	"github.com/brsuite/brond/btcec/v2/ecdsa"
	"github.com/brsuite/brond/bronutil"
	"github.com/brsuite/brond/bronutil/hdkeychain"
	"github.com/brsuite/brond/bronutil/psbt"
...
type WalletController interface {
	...
	// to this wallet.
	AddressInfo(a bronutil.Address) (waddrmgr.ManagedAddress, error)
	...
	LeaseOutput(id wtxmgr.LockID, op wire.OutPoint,
		duration time.Duration) (time.Time, []byte, bronutil.Amount,
		error)
	...
	// which could be e.g. brond, bitcoind, neutrino, or another consensus
	// service.
	BackEnd() string
}
...
type WalletDriver struct {
	...
	// wallet driver. This could be e.g. bitcoind, brond, neutrino, etc.
