...
type Chain struct {
	...
	Node string `long:"node" description:"The blockchain interface to use." choice:"brond" choice:"bitcoind" choice:"neutrino" choice:"ltcd" choice:"litecoind" choice:"nochainbackend"`
