...
import (
	...
	"github.com/brolightningnetwork/broln/tlv"
)
		...
		for _, ref := range invoicesToDelete {
			...
			if ref.PayAddr != nil {
				...
				if bytes.Equal(key, invoiceKey) {
					...
					// for this invoice.
					// ref: https://github.com/brolightningnetwork/broln/pull/4285/commits/cbf71b5452fa1d3036a43309e490787c5f7f08dc#r426368127
