...
import (
	...
	mig24 "github.com/brolightningnetwork/broln/channeldb/migration24"
	mig "github.com/brolightningnetwork/broln/channeldb/migration_01_to_11"
...
var (
	...
	remoteCommit0 = mig.ChannelCommitment{
		...
		CommitFee:     bronutil.Amount(1),
		FeePerKw:      bronutil.Amount(1),
		CommitTx:      dummyTx,
		CommitSig:     dummySig,
		Htlcs:         []mig.HTLC{},
	}
