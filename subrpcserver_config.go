...
import (
	...
	"github.com/brolightningnetwork/broln/lnrpc/devrpc"
	"github.com/brolightningnetwork/broln/lnrpc/invoicesrpc"
	"github.com/brolightningnetwork/broln/lnrpc/neutrinorpc"
...
type subRPCServerConfigs struct {
	...
	// developers manipulate broln state that is normally not possible.
